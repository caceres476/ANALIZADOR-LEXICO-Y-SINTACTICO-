...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnArchivo.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnAnalizarLex.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnLimpiarLex.setForeground(new java.awt.Color(153, 0, 0));
        ...
        jLabel2.setText("MARIO GRAJEDA");

        jLabel3.setText("DAVID CACERES");

        jLabel4.setText("DANY TAHUAL");

        jLabel5.setText("MARLON CUCO");
        ...
        btnAnalizarSin.setForeground(new java.awt.Color(0, 51, 51));
        ...
        btnLimpiarSin.setForeground(new java.awt.Color(153, 0, 0));
